...
>
  <div className={`w-full md:w-5/6 lg:w-5/12 ${isLeft ? 'md:pr-8' : 'md:pl-8'}`}>
    <div className="relative bg-gray-800 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 relative overflow-hidden group">
      <div className="absolute inset-0 bg-gradient-to-r from-blue-500/20 to-purple-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
      <div className="absolute top-1 left-1 z-10 ">
        <span className={`px-2 py-1 text-xs font-semibold rounded-lg ${meet.meet_active_status ? 'bg-green-500 text-white' : 'bg-red-500 text-white opacity-50'}`}>
      ...
      <div className="relative z-10 flex flex-col p-4">
        ...
        <div className="flex items-center space-x-4 text-sm text-white mb-2">
          <div className="flex items-center">
            ...
            <p>{new Date(meet.meet_date).toLocaleDateString('en-GB', { day: '2-digit', month: '2-digit', year: '2-digit' })}</p>
          </div>
          <div className="flex items-center">
