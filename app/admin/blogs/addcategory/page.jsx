...
import {FaBars, FaCalendarAlt, FaCog, FaPlane, FaTools, FaTrophy, FaUsers} from 'react-icons/fa';
...
const CategoryManager = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen bg-black">
      {/* Sidebar */}
      <aside
        className={`bg-blue-800 text-white w-full md:w-64 space-y-6 py-7 px-2 absolute inset-y-0 left-0 transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:relative md:translate-x-0 transition duration-200 ease-in-out z-20`}>
      ...
      <div className="flex-1 pt-24 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-x-hidden overflow-y-auto p-4 md:p-8">
          <form onSubmit={handleAddCategory} className="mx-auto space-y-12">
            ...
            <div className="space-y-4">
              <label htmlFor="description" className="block text-lg font-semibold text-gray-500">Category
                Description</label>
              <textarea
                id="description"
                name="description"
              ...
              ></textarea>
              <p className="text-sm text-gray-500 italic">A good description helps users understand the category&apos;s
                purpose.</p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-500 italic">Select a parent category to create a hierarchy, or leave as
                None for a top-level category.</p>
            </div>
