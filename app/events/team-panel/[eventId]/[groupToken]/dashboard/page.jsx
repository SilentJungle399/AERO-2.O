...
const TeamDashboard = () => {
  ...
  return (
    <>
      ...
      <div
        className="relative min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-blue-900 text-white p-4 sm:p-8">
        {/* Background layers */}
        ...
        <div className="relative z-10 max-w-6xl mx-auto pt-24 sm:pt-16">
          <h1
            className="text-3xl sm:text-4xl md:text-5xl monoton mb-4 sm:mb-6 text-center text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-blue-500">
            Skyforge 1.0
          </h1>
          ...
          <div
            className="bg-gray-800 mt-4 bg-opacity-50 backdrop-filter backdrop-blur-lg rounded-xl shadow-2xl p-4 sm:p-6 mb-8">
          ...
          <div
            className="bg-gray-800 bg-opacity-50 backdrop-filter backdrop-blur-lg rounded-xl shadow-2xl p-4 sm:p-6 mb-8">
            <h2 className="text-xl sm:text-2xl font-semibold mb-4 text-purple-400">
                ...
                {team.Group_members_team_ids.map((member, index) => (
                  <tr key={member._id} className={index % 2 === 0 ? "bg-gray-700 bg-opacity-30" : ""}>
                    ...
                    <td className="py-2 px-3">
                      <a href={member.Payment_sc} target="_blank" rel="noopener noreferrer"
          ...
          <div
            ...
            <p className="text-yellow-300 mb-4">Below you will get all resources of workshop once we will start with the
              workshop will get started!!</p>
            <ul className="list-disc list-inside text-blue-300">
              <li>
                <a
                  href="https://docs.google.com/presentation/d/1Zj_Fzg6LNh6NAWKn1RmH3d4c84XhnWIg/edit?usp=sharing&ouid=108628649323282460611&rtpof=true&sd=true"
                  target="_blank" rel="noopener noreferrer" className="underline hover:text-blue-400">
                  Day 1 : Introduction to Drones
                </a>
              </li>
              <li>
                <a
                  href="https://docs.google.com/presentation/d/1Ogqio2iLtnQHSw0DBce3mm8zYWoA-lLh/edit?usp=sharing&ouid=108628649323282460611&rtpof=true&sd=true"
                  target="_blank" rel="noopener noreferrer" className="underline hover:text-blue-400">
              ...
              <li>
                <a
                  href="https://docs.google.com/presentation/d/1jyi86x2pOrv5a4o9kIkh9UJZR26Y3ZQg/edit?usp=sharing&ouid=108628649323282460611&rtpof=true&sd=true"
                  target="_blank" rel="noopener noreferrer" className="underline hover:text-blue-400">
          ...
          <div
            ...
            <ul className="list-disc list-inside text-blue-300">
              <li>
                <a
                  href="https://docs.google.com/forms/d/e/1FAIpQLSeOqaIL_guNVc4oXY2VzS3C6jTy7YYfCANnpnjV8qux9UVJfw/viewform?usp=sf_link"
                  target="_blank" rel="noopener noreferrer" className="underline hover:text-blue-400">
                  Feedback Form
                </a>
              </li>
