...
export default function CreateTeamPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // if (isIndividualEvent && !formData.g_leader_name.trim()) {
      //   await setFormData(prev => ({
      //     ...prev,
      //     g_leader_name: formData.team_name
      //   }));
      // }
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                {JSON.parse(eventData.E_guidelines[0] ?? "[]").map((guideline, index) => (
            ...
            ? [
              {
                name: "team_name",
                icon: <FiStar/>,
                placeholder: isIndividualEvent ? "Your Name" : "Team Name"
              },
              {
                name: "g_leader_email", icon: <FiMail/>,
                placeholder: isIndividualEvent ? "Your E-mail" : "Group Leader E-mail"
              },
              {
                name: "g_leader_mobile", icon: <FiPhone/>,
                placeholder: isIndividualEvent ? "Your mobile" : "Group Leader mobile"
              },
            ]
            : stage === 3
              ? [
        ...
        return (
          <motion.form
            ...
            onSubmit={(e) => {
              ...
              if (stage === 4) {
                ...
                setStage(stage === 2 && isIndividualEvent ? stage + 2 : stage + 1);
              }
            }}
            initial={{opacity: 0, y: 20}}
            animate={{opacity: 1, y: 0}}
          ...
          >
            ...
            <div className="flex justify-between">
              <button
                type="button"
                onClick={() => setStage(stage === 4 && isIndividualEvent ? stage - 2 : stage - 1)}
              ...
              {submitLoading ? (
                ...
                <button
                  ...
                  onClick={() => stage < 4 && setStage(stage === 2 && isIndividualEvent ? stage + 2 : stage + 1)}
