...
import {FiArrowRight, FiCalendar, FiCopy, FiMail, FiPhone, FiUser,} from "react-icons/fi";
...
export default function CreateRegistrationPage() {
  ...
  return (
    <div
      className="min-h-screen pt-20 bg-black text-white flex items-center justify-center p-4 relative overflow-hidden">
