...
import FractalTree from './Fractletree'; // Ensure the import path is correct
                ...
                <div className="flex flex-col lg:flex-row gap-8 p-6 md:p-10 lg:p-16 max-w-6xl">
                  <div className="lg:w-1/2 space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mt-6">
                      <Link href={`/drones/events/create-team/${event._id}`} passHref>
                        <motion.a
                      ...
                      <Link href={`/drones/events/join-team/${event._id}`} passHref>
                        <motion.a
